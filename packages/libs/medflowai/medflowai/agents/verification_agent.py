...
class VerificationAgentInput(GenericInput):
    # query from GenericInput can provide overall context or goal for the verification.
...
class VerificationAgentOutput(GenericOutput):
    # response from GenericOutput can provide a high-level summary of the verification outcome.
    ...
    verification_status: str = Field(..., description="The outcome of the verification (e.g., 'Verified', 'Contradicted', 'Needs Clarification').")
...
class VerificationAgent(BaseAgent):
    ...
    async def run(self, input_data: VerificationAgentInput, context: Optional[Dict[str, Any]] = None) -> VerificationAgentOutput:
        ...
        return VerificationAgentOutput(
            ...
            verification_status="Verified" if is_consistent_placeholder else "Contradicted"
        )
