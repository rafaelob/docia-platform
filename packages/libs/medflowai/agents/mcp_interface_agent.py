...
class MCPInterfaceAgentInput(AgentInput):
    # query from AgentInput might describe the high-level task for the MCP
...
class MCPInterfaceAgentOutput(AgentOutput):
    # response from AgentOutput can summarize the outcome
